import {
    IonButton,IonInput,IonLabel,IonTextarea,IonItem,IonList,IonToast,IonSelect,IonSelectOption,IonContent,
 ...
 IonText
  ...
  const EnvNotificaciones: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        ...
        const res = await axios.post("http://10.0.2.2:3000/api/tab3", payload);
  ...
  export default EnvNotificaciones;
